...
if __name__ == '__main__':
    ...
    features = {
        ...
        "sentence": "sentence_features_doc2vec_bert_768"
    }
    ...
    data_loader, input_data_par = get_loader(dataset, features, DATA_DIR, batch_size)

    print('...Data loading is completed...')

    model_ft = IDCM_NN(img_input_dim=input_data_par['img_dim'], text_input_dim=input_data_par['text_dim'],
    ...
    view1_feature, view2_feature, view1_predict, view2_predict = model_ft(
